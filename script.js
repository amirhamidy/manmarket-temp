...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (addToPwaButton) {
        addToPwaButton.addEventListener('click', () => {
            Swal.fire({
                ...
                didOpen: () => {
                    ...
                    if (infoIcon) {
                        infoIcon.style.borderColor = '#f96747';
                        infoIcon.style.color = '#f96747';
                    }
                    const button = Swal.getConfirmButton();
                    if (button) {
                        button.style.backgroundColor = '#f96747';
                    }
                }
            });
        });
